(function () {
  ...
  function sendMessageToParent(data) {
      ...
      window.parent.postMessage({ type: "YPFT_IFRAME", ...msg }, "https://www.twitch.tv");
  }

  function receiveMessage(event) {
    if (event.origin !== "https://www.twitch.tv" || event.data?.type !== 'YPFT_IFRAME') return;
  ...
  function insertTheaterButton() {
    ...
    if (!fullscreenButton) {
      console.warn('Fullscreen button not found, cannot add theater mode button');
      return;
    }
